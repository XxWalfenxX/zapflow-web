...
onMounted(() => {
    ...
    form.id = props.bono.id
    form.name = props.bono.nombre
    form.precio = props.bono.precio
    additionalDescriptions.value = props.bono.descripcion.split(', ')
})
...
const props = defineProps(['bono'])

const submit = () => {
    form.des = additionalDescriptions.value
    form.patch(route('admin.bonos.update'), {
        preserveScroll: true,
...
<template>
    <!-- Modal toggle -->
    <button type="button" :data-modal-target="`updateModal-${props.bono.id}`" :data-modal-toggle="`updateModal-${props.bono.id}`"
    ...
    <!-- Main modal -->
    <div :id="`updateModal-${props.bono.id}`" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        :data-modal-toggle="`updateModal-${props.bono.id}`">
                ...
                <form @submit.prevent="submit">
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="name" id="name" v-model="form.name"
                                ...
                                placeholder="ZapFriend" required>
                        </div>
                    ...
                    <InputError class="my-2" :message="form.errors.precio" />
                    <InputError class="my-2" :message="form.errors.name" />
                    <InputError class="my-2" :message="form.errors.des" />
                    <button type="submit"
