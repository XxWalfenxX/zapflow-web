...
import SelectUserVeh from '@/Components/Modal/Users/CargaVehiculos/SelectUserVeh.vue';
import AddUsersVehModal from '@/Components/Modal/Users/CargaVehiculos/AddUsersVehModal.vue';
...
function groupByIdUser(data) {
  ...
  data.forEach(item => {
    ...
    const role = { id_roles: item.id_punto_carga, nombre: item.ubicacion };
...
<template>
    <Head title="Gestión Carga Vehículos" />

    <AuthenticatedLayout>
        <div class="py-12 flex-grow min-h-[80vh]">

            <div class="mx-auto sm:px-6 lg:px-8">
                <h1 class="font-bold text-4xl mb-3 dark:text-white">Gestionar Carga de Vehiculos</h1>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="mb-3">
                            <AddUsersVehModal :bonos-avail="bonosAvail" :users-avail="usersAvail"/>
                        </div>
                            ...
                            <DataTable :options="options" class="display w-full">
                                ...
                                <tbody>
                                    <tr v-for="user in userBonosSorted">
                                        ...
                                        <td>
                                            <SelectUserVeh :user="user" :roles="bonosAvail"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </DataTable>
