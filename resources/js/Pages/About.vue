            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-300">
                        Somos una empresa dedicada a la instalación y gestión de
        ...
        >
            <div class="mx-auto max-w-2xl lg:max-w-4xl">
                <div class="flex flex-wrap items-center ">
                    <img
                        src="img/logo.png"
                        class="ml-auto mr-5 md:h-24 h-10"
                        alt="ZapFlow Logo"
                    />
                    <span
                        class="self-center md:text-7xl font-semibold whitespace-nowrap dark:text-white mr-auto text-2xl"
                        >ZapFlow</span
                    >
                </div>
